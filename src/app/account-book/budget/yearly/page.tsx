...
export default function YearlyBudgetPage() {
  ...
  // 샘플 데이터 - 실제로는 API에서 불러올 데이터 (연간 스케일)
  useEffect(() => {
    const sampleBudgetStatus: BudgetStatus = {
      totalBudget: 24000000, // 연간 예산
      totalSpent: 19800000,
      ...
      categories: [
        {
          id: "1",
          name: "식비",
          allocated: 7200000, // 월간 60만원 × 12개월
          spent: 6240000,
          remaining: 960000,
          percentage: 86.7,
          isOverBudget: false,
        ...
        },
        {
          id: "2",
          name: "교통비",
          allocated: 2400000, // 월간 20만원 × 12개월
          spent: 2880000,
          remaining: -480000,
          percentage: 120,
          isOverBudget: true,
        ...
        },
        {
          id: "3",
          name: "쇼핑",
          allocated: 4800000, // 월간 40만원 × 12개월
          spent: 4200000,
          remaining: 600000,
          percentage: 87.5,
          isOverBudget: false,
        ...
        },
        {
          id: "4",
          name: "문화생활",
          allocated: 3600000, // 월간 30만원 × 12개월
          spent: 2160000,
          remaining: 1440000,
          percentage: 60,
          isOverBudget: false,
        ...
        },
        {
          id: "5",
          name: "기타",
          allocated: 6000000, // 월간 50만원 × 12개월
          spent: 4320000,
          remaining: 1680000,
          percentage: 72,
          isOverBudget: false,
  ...
  return (
    <div className="grow flex flex-col gap-6 p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
        ...
        <button className="p-4 bg-white rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all group">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              <p className="font-medium text-gray-800">목표 설정</p>
              <p className="text-sm text-gray-600">내년 계획 수립</p>
            </div>
          </div>
        </button>
      </div>
